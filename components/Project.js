        ...
        <div className={styles.projectButtons}>
          <Link href={website} passHref legacyBehavior>
            <a target="_blank" rel="noreferrer">
                <button>
                  <svg xmlns="http://www.w3.org/2000/svg" className={styles.specialSvg} width="24" height="24" viewBox="0 0 24 24">
                  ...
                  {extension === "yes" ? <span>Marketplace</span> : <span>Website</span>}
                </button>
            </a>
          </Link>
